...
```R
    input.args[[1]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/3sp_tpm_all.tsv"
```
...
```R
    input.args[[1]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/dmel_dsec_dsim_conserved_orthologs.tsv"
    input.args[[2]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/dmel_dsec_dsim_in_paralogs.tsv"
    input.args[[3]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/dmel_dsec_dsim_out_paralogs.tsv"
    input.args[[4]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/dmel_dsec_dsim_special_in_paralogs.tsv"
    input.args[[5]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/dmel_dsec_dsim_special_out_paralogs.tsv"
```

3. example: Rscript exec/load_gene_families_data.R <families_file> 
```R
    input.args[[1]] <- "experiments/test_diet_P_&_M_new_3_species_tpm_all/orthogroups.tsv"
```
